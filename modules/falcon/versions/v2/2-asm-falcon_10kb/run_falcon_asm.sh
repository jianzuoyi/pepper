...
# Given, las.fofn,
# write preads.ovl:
time fc_ovlp_filter --db /its1/GB_BT2/jianzuoyi/workspace/pepper/modules/falcon/1-preads_ovl/preads.db --fofn /its1/GB_BT2/jianzuoyi/workspace/pepper/modules/falcon/1-preads_ovl/merge-gather/las.fofn --max_diff 100 --max_cov 100 --min_cov 2 --n_core 24 --min_len 10000 >| preads.ovl
...
time fc_ovlp_to_graph  --min_len 10000 preads.ovl >| fc_ovlp_to_graph.log
